...
var App, ChatInput, Messagelist, MessagelistItem, Navbar, NickInput, Player, PlayerAudio, PlayerHead, Playlist, PlaylistItem, Preset, R, Titleblock, channel, denormalize, el, exttype, fetchdata, lpad, memottl, normalize, pathname, randomid, sock, time, trim;
...
Messagelist = React.createClass({
  ...
  componentDidMount: function() {
    ...
    return sock.on('chat', (function(_this) {
      return function(msg) {
        _this.state.history.unshift(msg);
        while (_this.state.history.length > 32) {
          _this.state.history.pop();
        }
        return _this.setState({
          history: _this.state.history
        });
