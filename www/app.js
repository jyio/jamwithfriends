...
var App, ChatInput, Messagelist, MessagelistItem, Navbar, NickInput, Player, PlayerHead, Playlist, PlaylistItem, Preset, R, Titleblock, channel, denormalize, el, exttype, fetchdata, isInViewport, isMobile, lpad, memottl, normalize, pathname, randomid, time, trim;
...
PlayerHead = React.createClass({
  ...
  render: function() {
    ...
    }, this.props.formatname.toUpperCase()), ' ', R.span({
      className: 'label label-default',
      style: {
        fontWeight: 'bold'
      }
    }, "" + this.state.minutes + ":" + (lpad(this.state.seconds, 2))), R.br(null), R.a({
